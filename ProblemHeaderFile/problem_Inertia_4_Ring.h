...
#include "calculate_Inertia_4_Ring.h"
...
//7.4
void Inertia_4_Ring(SDL_Window* window, SDL_Renderer* render, SDL_Texture* img[],SDL_Rect img_rect[],int &mouse_x,int &mouse_y){
    ...
    //Input surface
    rin.font= TTF_OpenFont("Ubuntu/Ubuntu-Bold.ttf",26);
    ...
    while(run){
        ...
        SDL_RenderCopy(render,img[69],NULL,&rect[2]);

        //image ring_diameter
        rect[3]={450,10,350,300};
        SDL_RenderCopy(render,img[70],NULL,&rect[3]);

        //image ring_tangent
        rect[19]={840,10,350,300};
        SDL_RenderCopy(render,img[71],NULL,&rect[19]);

        //back button
        rect[0]={0,0,100,50};
        SDL_SetRenderDrawColor(render,140,200,30,140);
        SDL_RenderFillRect(render,&rect[0]);
        surface = TTF_RenderText_Solid(rin.font, " BACK ", color);
        ...
        //type
        surface=TTF_RenderText_Solid(rin.font," Ring",color2);
        tex=SDL_CreateTextureFromSurface(render,surface);
        ...
        //option 1
        surface=TTF_RenderText_Solid(rin.font,"1. Inertia about Center axis ",color1);
        tex=SDL_CreateTextureFromSurface(render,surface);
        ...
        //option 2
        surface=TTF_RenderText_Solid(rin.font,"2. Inertia about Diameter axis ",color1);
        tex=SDL_CreateTextureFromSurface(render,surface);
        ...
        //option 3
        surface=TTF_RenderText_Solid(rin.font,"3. Inertia about tangent axis ",color1);
        tex=SDL_CreateTextureFromSurface(render,surface);
        ...
        //options
        surface=TTF_RenderText_Solid(rin.font,"1 / 2 / 3 ?",color1);
        tex=SDL_CreateTextureFromSurface(render,surface);
        ...
        //mass
        surface=TTF_RenderText_Solid(rin.font," m - mass of the ring (kg): ",color);
        tex=SDL_CreateTextureFromSurface(render,surface);
        ...
        //radius
        surface= TTF_RenderText_Solid(rin.font," r - radius of the ring (m): ",color);
        tex=SDL_CreateTextureFromSurface(render,surface);
        ...
        surface = TTF_RenderText_Solid(rin.font, " CALCULATE ", color);
        tex = SDL_CreateTextureFromSurface(render, surface);
                    ...
                    switch(e.button.button){
                        ...
                        if((mouse_x>=0&&mouse_x<=100)&&(mouse_y>=0&&mouse_y<=50)){
                            ...
                            SDL_ShowSimpleMessageBox(10,"Invalid","Please fill Every box properly!",window);
                                ...
                                Cal_Inertia_4_Ring(window,render,img,img_rect,st1,st2,st3,mouse_x,mouse_y);
                                st1.clear();st2.clear();st3.clear();
                            }
                        }
                        break;
        ...
        //input 1
        if ( st1.size() ) {
            surface = TTF_RenderText_Solid(rin.font, st1.c_str(), color);
            tex = SDL_CreateTextureFromSurface(render, surface);
        ...
        //input 2
        if ( st2.size() ) {
            surface = TTF_RenderText_Solid(rin.font, st2.c_str(), color);
            tex = SDL_CreateTextureFromSurface(render, surface);
        ...
        //input 3
        if ( st3.size() ) {
            surface = TTF_RenderText_Solid(rin.font, st3.c_str(), color);
            tex = SDL_CreateTextureFromSurface(render, surface);
