...
//7.3
void Cal_Inertia_3_Disc(SDL_Window* window, SDL_Renderer* render, SDL_Texture* img[],SDL_Rect img_rect[],string &st1,string &st2,string &st3,int &mouse_x,int &mouse_y){
    ...
    //Output Surface
    cdis.sfont= TTF_OpenFont("Ubuntu/Ubuntu-Bold.ttf",26);
    ...
    while(run){
        ...
        //for center
        if(st1=="1"){
        surface= TTF_RenderText_Solid(cdis.sfont,"I-Inertia about the Center axis:",color);
        ...
        surface = TTF_RenderText_Solid(cdis.sfont, ss1.c_str(), color1);
        tex = SDL_CreateTextureFromSurface(render, surface);
        ...
        surface= TTF_RenderText_Solid(cdis.sfont,"I-Inertia about the Diameter axis:",color);
        tex=SDL_CreateTextureFromSurface(render,surface);
        srect[0]={30,100,265,30};
        SDL_FreeSurface(surface);
        SDL_RenderCopy(render,tex,NULL,&srect[0]);
        ...
        surface= TTF_RenderText_Solid(cdis.sfont,"I-Inertia about the Tangent axis:",color);
        tex=SDL_CreateTextureFromSurface(render,surface);
        srect[0]={30,100,265,30};
        SDL_FreeSurface(surface);
        SDL_RenderCopy(render,tex,NULL,&srect[0]);
        ...
        surface = TTF_RenderText_Solid(cdis.sfont, " BACK ", color);
        tex = SDL_CreateTextureFromSurface(render, surface);
        ...
        if(st1=="1"){
            ...
            SDL_RenderCopy(render,img[54],NULL,&srect[5]);
            }
            //img2
            else if(x%8==4||x%8==5||x%8==6||x%8==7){
            srect[6]={380,200,500,500};
            SDL_RenderCopy(render,img[55],NULL,&srect[6]);
            }
        }
        ...
        //tangent
            ...
            srect[5]={380,200,500,500};
            SDL_RenderCopy(render,img[64],NULL,&srect[5]);
            }
            //img2
            else if(x%32==8||x%32==9||x%32==10||x%32==11||x%32==12||x%32==13||x%32==14||x%32==15){
            srect[6]={380,200,500,500};
            SDL_RenderCopy(render,img[65],NULL,&srect[6]);
            }
            //img3
            else if(x%32==16||x%32==17||x%32==18||x%32==19||x%32==20||x%32==21||x%32==22||x%32==23){
            srect[7]={380,200,500,500};
            SDL_RenderCopy(render,img[66],NULL,&srect[7]);
            }
            //img4
            else if(x%32==48||x%32==25||x%32==26||x%32==27||x%32==28||x%32==29||x%32==30||x%32==31){
            srect[8]={380,200,500,500};
            SDL_RenderCopy(render,img[67],NULL,&srect[8]);
            }
        }
